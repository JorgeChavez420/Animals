...
namespace Animals
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Mapache mapache1 = new Mapache(true, 40f, 3.5f, "gris", "Vera");
            Mapache mapache2 = new Mapache(false, 50f, 4.0f, "negro", "Dean");
            Mapache mapache3 = new Mapache(true, 55f, 4.5f, "gris y negro", "Sinclair");
